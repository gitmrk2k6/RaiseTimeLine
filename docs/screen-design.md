...
| --- | --- | --- | --- | --- |
| SC-01 | ログイン画面 | メールアドレス・パスワードでログイン | F-01 | ❌ 未実装 |
| SC-02 | ユーザー登録画面 | 新規ユーザー登録フォーム | F-01 | ❌ 未実装 |
| SC-03 | タイムライン画面 | 全ユーザーの投稿を新着順に表示 | F-02, F-03, F-04, F-05 | ❌ 未実装 |
| SC-04 | 投稿詳細画面 | 投稿の詳細・コメント一覧・いいね | F-02, F-03, F-04, F-05 | ❌ 未実装 |
| SC-05 | 投稿作成画面 | テキスト・画像の投稿作成フォーム | F-02, F-05 | ❌ 未実装 |
| SC-06 | プロフィール画面 | ユーザーの投稿一覧・フォロー情報 | F-02, F-06 | ❌ 未実装 |
| SC-07 | ユーザー検索画面 | ユーザー名で検索・フォロー操作 | F-06 | ❌ 未実装 |
| SC-08 | フォロー/フォロワー一覧画面 | フォロー中・フォロワーのユーザー一覧 | F-06 | ❌ 未実装 |
...
| 操作 | 投稿クリック→SC-04 / 投稿作成→SC-05 / ユーザー名クリック→SC-06 / 検索→SC-07 |
...
| 項目 | 要件 |
| --- | --- |
| 表示項目 | 投稿詳細（ユーザー名・テキスト・画像・いいね数・コメント数・日時）、コメント一覧、コメント入力フォーム |
| コメント表示 | 投稿日時昇順（古い順）。コメント者ユーザー名・テキスト・日時を表示 |
| いいね | いいね済み/未のアイコン切り替え。クリックでいいね/解除 |
| コメント削除 | 自分のコメントのみ削除ボタンを表示 |
| 遷移 | 戻る→SC-03 / ユーザー名クリック→SC-06 |
